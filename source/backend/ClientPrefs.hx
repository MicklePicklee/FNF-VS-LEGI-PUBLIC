...
@:structInit class SaveVariables {
	...
	public var noteSkin:String = 'LEGI';
	public var splashSkin:String = 'LEGI';
	...
	public var pauseMusic:String = 'Picnic';
	public var menuTheme:String = 'Walk In The Park';
	public var mainBPM:Float = 101.970;
